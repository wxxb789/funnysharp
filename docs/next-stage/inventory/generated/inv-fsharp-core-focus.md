# Public API inventory: FSharp.Core 10.1.401 (lib/netstandard2.1) — focus set
...
### ValueOption (class [static])

- `public static Microsoft.FSharp.Core.FSharpValueOption<TResult> Bind<T, TResult>(Microsoft.FSharp.Core.FSharpFunc<T, Microsoft.FSharp.Core.FSharpValueOption<TResult>> binder, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Boolean Contains<T>(T value, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Int32 Count<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static T DefaultValue<T>(T value, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static T DefaultWith<T>(Microsoft.FSharp.Core.FSharpFunc<Microsoft.FSharp.Core.Unit, T> defThunk, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Boolean Exists<T>(Microsoft.FSharp.Core.FSharpFunc<T, System.Boolean> predicate, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> Filter<T>(Microsoft.FSharp.Core.FSharpFunc<T, System.Boolean> predicate, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> Flatten<T>(Microsoft.FSharp.Core.FSharpValueOption<Microsoft.FSharp.Core.FSharpValueOption<T>> voption)`
- `public static TState Fold<T, TState>(Microsoft.FSharp.Core.FSharpFunc<TState, Microsoft.FSharp.Core.FSharpFunc<T, TState>> folder, TState state, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static TState FoldBack<T, TState>(Microsoft.FSharp.Core.FSharpFunc<T, Microsoft.FSharp.Core.FSharpFunc<TState, TState>> folder, Microsoft.FSharp.Core.FSharpValueOption<T> voption, TState state)`
- `public static System.Boolean ForAll<T>(Microsoft.FSharp.Core.FSharpFunc<T, System.Boolean> predicate, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static T GetValue<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Boolean IsNone<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Boolean IsSome<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static System.Void Iterate<T>(Microsoft.FSharp.Core.FSharpFunc<T, Microsoft.FSharp.Core.Unit> action, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<TResult> Map<T, TResult>(Microsoft.FSharp.Core.FSharpFunc<T, TResult> mapping, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<TResult> Map2<T1, T2, TResult>(Microsoft.FSharp.Core.FSharpFunc<T1, Microsoft.FSharp.Core.FSharpFunc<T2, TResult>> mapping, Microsoft.FSharp.Core.FSharpValueOption<T1> voption1, Microsoft.FSharp.Core.FSharpValueOption<T2> voption2)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<TResult> Map3<T1, T2, T3, TResult>(Microsoft.FSharp.Core.FSharpFunc<T1, Microsoft.FSharp.Core.FSharpFunc<T2, Microsoft.FSharp.Core.FSharpFunc<T3, TResult>>> mapping, Microsoft.FSharp.Core.FSharpValueOption<T1> voption1, Microsoft.FSharp.Core.FSharpValueOption<T2> voption2, Microsoft.FSharp.Core.FSharpValueOption<T3> voption3)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> OfNullable<T>(T?? value)`
- `where T : struct`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> OfObj<T>(T value)`
- `where T : class`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> OfOption<T>(Microsoft.FSharp.Core.FSharpOption<T> option)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> OrElse<T>(Microsoft.FSharp.Core.FSharpValueOption<T> ifNone, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Core.FSharpValueOption<T> OrElseWith<T>(Microsoft.FSharp.Core.FSharpFunc<Microsoft.FSharp.Core.Unit, Microsoft.FSharp.Core.FSharpValueOption<T>> ifNoneThunk, Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static T[] ToArray<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static Microsoft.FSharp.Collections.FSharpList<T> ToList<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `public static T? ToNullable<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
- `where T : struct`
- `public static T ToObj<T>(Microsoft.FSharp.Core.FSharpValueOption<T> value)`
- `where T : class`
- `public static Microsoft.FSharp.Core.FSharpOption<T> ToOption<T>(Microsoft.FSharp.Core.FSharpValueOption<T> voption)`
