...
- **Authority:** `docs/goals/archive/0003-goal.md` defines the feature outcome. `docs/product-contract.md` defines package and runtime boundaries. Existing function-composition code and evidence patterns define repository conventions.
...
- **Collection scope stops at dictionary lookup.** Sequence traversal and accumulation remain owned by `docs/goals/archive/0005-goal.md`. Governs R9, R13.
...
- All `Option`/`Result` interoperation; `docs/goals/archive/0004-goal.md` owns that public surface.
- Sequence, traversal, accumulation, and asynchronous collection combinators owned by `docs/goals/archive/0005-goal.md`.
...
- `docs/goals/archive/0003-goal.md` defines the requested feature and evidence.
- `docs/goals/archive/0004-goal.md` reserves explicit typed failures for `Result`.
- `docs/goals/archive/0005-goal.md` reserves sequence traversal and accumulation.
...
- **Exception-catching factory:** Rejected because exceptions and cancellation are failures. `docs/goals/archive/0004-goal.md` owns explicit failure conversion.
- **Sequence lookup and traversal family:** Deferred to `docs/goals/archive/0005-goal.md` to avoid accidental collection-framework growth.
